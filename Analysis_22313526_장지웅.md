...
|---|---|
| **10a** | **General User가 피드백 전송을 원하지 않는 경우** |
| 10a1 | General User는 피드백 입력 팝업에서 “취소” 버튼을 클릭한다. |
...
2. StarUML Documentation, “Class Diagram.”  
   https://docs.staruml.io/working-with-uml-diagrams/class-diagram

3. Visual Paradigm, “What is Use Case Diagram?”  
   https://www.visual-paradigm.com/guide/uml-unified-modeling-language/what-is-use-case-diagram/

4. Visual Paradigm, “What is Class Diagram?”  
...
7. NVIDIA Developer, “CUDA Toolkit Documentation.”  
   https://docs.nvidia.com/cuda/

8. PyTorch Documentation, “CUDA semantics.”  
   https://pytorch.org/docs/stable/notes/cuda.html

9. OpenCV Documentation, “Image Processing in OpenCV.”  
   https://docs.opencv.org/

10. Selvaraju, R. R., Cogswell, M., Das, A., Vedantam, R., Parikh, D., & Batra, D. (2017). “Grad-CAM: Visual Explanations from Deep Networks via Gradient-based Localization.” *Proceedings of the IEEE International Conference on Computer Vision (ICCV)*.

11. GitHub Docs, “Basic writing and formatting syntax.”  
